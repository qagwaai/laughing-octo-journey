...
describe('ShipExteriorRouteFeedLayer', () => {
  ...
  it('renders one station octahedron per station feed item and supports alternate station feeds', () => {
    const fixture = TestBed.createComponent(HostComponent);
    const host = fixture.componentInstance;
    host.stations = [
      {
    ...
    const fixtureAlt = TestBed.createComponent(HostComponent);
    const hostAlt = fixtureAlt.componentInstance;
    hostAlt.stations = [
      {
        id: 'station-3',
    ...
    fixtureAlt.detectChanges();

    geometries = fixtureAlt.debugElement.queryAll(By.css('ngt-octahedron-geometry'));
