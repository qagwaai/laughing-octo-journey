...
function createFixture() {
  const handlers = {
    onWindowPointerDown: jasmine.createSpy('onWindowPointerDown'),
    onWindowPointerUp: jasmine.createSpy('onWindowPointerUp'),
    onWindowContextMenu: jasmine.createSpy('onWindowContextMenu'),
    onWindowKeyDown: jasmine.createSpy('onWindowKeyDown'),
    onWindowKeyUp: jasmine.createSpy('onWindowKeyUp'),
    onWindowMouseMove: jasmine.createSpy('onWindowMouseMove'),
    onSocketCorrelationWarning: jasmine.createSpy('onSocketCorrelationWarning'),
    onPointerLockChange: jasmine.createSpy('onPointerLockChange'),
  };
