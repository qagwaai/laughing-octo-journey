import { canReachSolarSystemViaJumpGates, resolveJumpGateHops, type JumpGateLink } from './jump-gate';
...
describe('jump-gate model', () => {
  ...
  it('returns false when route exceeds max hops', () => {
    expect(canReachSolarSystemViaJumpGates('sol', 'barnards-star', 1, links)).toBe(false);
  });
});
