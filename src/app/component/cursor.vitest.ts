...
describe('Cursor', () => {
  ...
  let objectEventsSpy: ReturnType<typeof vi.fn>;
  ...
  beforeEach(() => {
    ...
    objectEventsSpy = vi.fn().mockImplementation((objectFn: any, handlers: any) => {
      return handlers;
    });
  ...
  describe('objectEvents integration', () => {
    ...
    it('should pass the native mesh element to objectEvents', () => {
      mockInjector.get(Cursor);
      const callArgs = objectEventsSpy.mock.calls[0];
