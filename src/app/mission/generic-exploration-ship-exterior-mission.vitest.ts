...
describe('GenericExplorationShipExteriorMission', () => {
  ...
  it('plugin hides repair/fabrication/launch panels', () => {
    ...
    expect(plugin.hudConfig.showFabricationLab).toBe(false);
    expect(plugin.hudConfig.showLaunchPanel).toBe(false);
    expect(plugin.hudConfig.showScanPanel).toBe(true);
  });
