...
describe('DroneViewSpecsPage', () => {
	it('should initialize selected drone context from navigation state', () => {
		const component = new MockDroneViewSpecsPage({
			playerName: 'Pioneer',
	...
	it('should handle missing drone context safely', () => {
		const component = new MockDroneViewSpecsPage({ playerName: 'Pioneer' });
