...
const MARKET_RADIUS_OPTIONS_AU: readonly number[] = [
  0.05,
  0.1,
  0.25,
  0.5,
...
export default class MarketHubPage {
  ...
  protected readonly activeDriveProfile = computed(() => resolveDriveProfileForShip(this.activeShip() ?? null));
