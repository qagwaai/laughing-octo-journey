  ...
  character: {
    ...
    setup: {
      ...
      bust: {
        ...
        viewer: {
          title: 'Portrait Viewer',
          subtitle: '2D portrait preview rendered from form state.',
          hint: 'Portraits are served directly from the configured image set. When a portrait is missing, the viewer shows not-found text for the exact filename.',
          controlsLabel: 'Portrait preview',
          resetLabel: 'Reset preview',
          assetPathLabel: 'Image root:',
          statePrefix: 'Preview state',
          distanceLabel: 'Image',
          azimuthLabel: 'Face set',
          polarLabel: 'Variant',
          sceneYOffsetLabel: 'Portrait file',
          renderLabel: 'Load status',
          interactionLabel: 'Preview',
          faceShapeLabel: 'Face shape',
          expressionLabel: 'Expression',
          assetStatusLabel: 'Dedicated SW-15 portrait asset path reserved.',
          cameraPresets: {
            front: 'Front',
