...
export const en = {
  ...
  public: {
    intro: {
      ...
      endgameBody1: 'The ultimate goal of Project Stellar is the transition from Manual Control to Total Autonomy.',
      endgameBody2:
  ...
  character: {
    ...
    setup: {
      ...
      bust: {
        sectionTitle: 'Bust Profile',
        sectionSubtitle: 'Tune facial presets before finalizing the character.',
        previewTitle: 'Live Preview',
        viewer: {
          title: '3D Bust Viewer',
          subtitle: 'High-fidelity portrait preview rendered from form state.',
          hint: 'Drag with the left mouse button to rotate, drag with the right mouse button to move the bust up or down in the scene, pinch or wheel to zoom, and switch camera presets for profile checks.',
          controlsLabel: 'Bust camera presets',
          resetLabel: 'Reset orientation',
          assetPathLabel: 'Asset root:',
          statePrefix: 'Camera state',
          distanceLabel: 'Distance',
          azimuthLabel: 'Azimuth',
          polarLabel: 'Polar',
          sceneYOffsetLabel: 'Scene Y offset',
          renderLabel: 'First render',
          interactionLabel: 'Interaction',
          faceShapeLabel: 'Face shape',
          expressionLabel: 'Expression',
          assetStatusLabel: 'Dedicated SW-15 bust path reserved.',
          cameraPresets: {
            front: 'Front',
        ...
        eyeStyleLabel: 'Eye Style',
        eyeColorLabel: 'Eye Color',
        expressionLabel: 'Expression',
        apparelAccentLabel: 'Apparel Accent',
        validationTitle: 'Bust profile validation failed',
        blockedSaveTitle: 'Bust save blocked',
        retrySaveLabel: 'Retry Bust Save',
        retryableLabel: 'This issue is retryable. Try again once dependencies recover.',
        notRetryableLabel: 'This issue is not retryable yet. Adjust input or resolve backend state first.',
        blockedSaveReasons: {
          PLAYER_NOT_REGISTERED: 'Player is not registered.',
          CHARACTER_NOT_FOUND: 'Character record was not found.',
          CHARACTER_BUST_NOT_FOUND: 'Character bust record does not exist yet for update.',
          NPC_BUST_NOT_FOUND: 'NPC bust record does not exist yet for update.',
          DATABASE_ERROR: 'Persistence layer returned a database error.',
        },
      },
      errors: {
  ...
  game: {
    ...
    repairRetrofit: {
      ...
      sectionDescription: 'Sample module: review damaged components, estimated repair windows, and retrofit options.',
    ...
    repairRetrofitItems: {
      ...
      blockedReasonMissionPartsUnavailable: 'Requires mission salvage parts not yet available',
      actionAvailabilityReady: 'Ready',
      actionAvailabilityNoAction: 'No action needed',
      actionAvailabilityBlocked: 'Blocked - pending mission content',
    ...
    marketHub: {
      ...
      localMarketsSectionTitle: 'Nearby Markets',
      searchSolarSystemLabel: 'Solar system filter:',
      driveNameLabel: 'Active drive:',
      activeShipStatusLabel: 'Active ship status:',
      driveRangeLabel: 'Drive range:',
      shipStatusUnknownLabel: 'unknown',
      radiusLabel: 'Search Radius (AU)',
      selectedRadiusLabel: 'Selected radius:',
      unlimitedRadiusLabel: 'Unlimited',
      marketTypeFiltersLabel: 'Market types:',
      includeStationsLabel: 'Include station markets',
      includeFreeFloatingLabel: 'Include free-floating markets',
      showOutOfRangeMarketsLabel: 'Show markets beyond current drive',
      outOfRangeToggleHintLabel:
        'Enables an unlimited scan (1,000,000 AU) and groups results below the reachable list.',
      applyRadiusLabel: 'Apply Radius',
      reloadMarketsLabel: 'Refresh Markets',
      loadingMarketsLabel: 'Loading markets...',
      activeShipPositionMissingLabel: 'Active ship position unavailable. Distance is currently estimated as unknown.',
      dockRequiredHintLabel: 'Dock at a market to transact. Browsing is available while undocked.',
      noLocalMarketsLabel: 'No markets found within selected range.',
      reachableMarketsSectionLabel: 'Reachable Markets',
      outOfRangeMarketsSectionLabel: 'Beyond Current Drive',
      dockRequiredBadgeLabel: 'Dock required',
      marketIdLabel: 'Market ID:',
      marketLocationLabel: 'Location:',
      marketDistanceLabel: 'Distance:',
      unknownDistanceLabel: 'Unknown distance',
      auLabel: 'AU',
      approxDistancePrefix: 'Approx',
      aboutPrefix: 'about',
      lessThanOneHourLabel: 'less than 1 hour',
      hourLabel: 'hour',
      hoursLabel: 'hours',
      standardCruiseSuffix: 'at standard cruise',
      awaySuffix: 'away',
      gateHopLabel: 'gate hop',
      gateHopsLabel: 'gate hops',
      unreachableRouteLabel: 'no known gate route',
      inSystemRouteLabel: 'In-system',
      noRouteLabel: 'No route',
      outOfRangeBadgeLabel: 'Out of range',
      requiresDriveUpgradeLabel: 'Requires drive range upgrade.',
      requiredDriveLabel: 'Required drive:',
    ...
    shipHangar: {
      ...
      sectionDescription: 'Sample module: list docked ships, sortie status, and launch bay reservations.',
      shipLoadingStatus: 'Loading ships...',
      shipEmptyStatus: 'No ships found for this character.',
      shipNameLabel: 'Name:',
      shipModelLabel: 'Model:',
    ...
    fabricationLab: {
      ...
      sectionDescription: 'Sample module: schedule production runs and inspect fabrication output quality.',
    ...
    missionBoard: {
      ...
      filterLabel: 'Mission lane filter',
      filterAllLabel: 'All Lanes',
      filterEmptyState: 'No missions match the selected lane filter.',
      ...
      availableLaneTitle: 'Available',
      activeLaneTitle: 'Active',
      completedLaneTitle: 'Completed',
      ...
      contractViolationPanelTitle: 'Contract Violation Detected',
      contractViolationPanelBody:
        'Mission statuses outside available/active/completed cannot be placed in a lane. Check producer payloads and contract gates.',
      errors: {
    ...
    viewer: {
      ...
      planetCountLabel: 'Planets:',
      moonCountLabel: 'Moons:',
      asteroidCountLabel: 'Asteroids:',
      ...
      planetViewPanelTitle: 'Planetary Lens',
      planetViewSelectedLabel: 'Selected',
      planetViewZoomPercentLabel: 'Zoom',
      planetViewRadiusLabel: 'Radius',
      ...
      legendGateLandmark: 'Jump Gate Landmark',
      legendActiveShip: 'Active Ship',
      legendInactiveShip: 'Inactive Ships',
      legendUnknownShip: 'Unknown location',
      gateApproachCueLabel: 'Gate Approach Cue',
      gateLandmarkFramingLabel: 'Landmark Framing',
      gateNavBeaconCueLabel: 'Nav Beacon Cue',
      gateHazardCueLabel: 'Hazard Cue',
      gateWarningEscalationLabel: 'Warning Escalation',
      gateRecommendedStandOffKmLabel: 'Recommended Stand-Off (km)',
      gateApproachWindowKmLabel: 'Approach Window (km)',
      detailsBackLabel: '← Back to Systems',
      detailsSectionTitle: 'Bodies & Markets',
      detailsLoadingStatus: 'Loading bodies...',
      detailsEmptyStatus: 'No bodies found for this system.',
      detailsErrorPrefix: 'Failed to load bodies:',
      detailsTargetButton: 'Target',
      detailsColumnName: 'Name',
  ...
  opening: {
    coldBoot: {
      ...
      armedTooltipOff: 'Audio is disabled. Click Enable Audio Hooks (or first pointer/key gesture) to unlock playback.',
      bedTooltipDisarmed: 'Bed is stopped because audio is not armed yet.',
      bedTooltipStopped: 'Bed is stopped. Re-enter this sequence or re-arm audio to start the loop again.',
      bedTooltipRunning: 'Bed loop is currently running.',
      speechTooltipAvailable: 'Speech synthesis is available for AI transmissions.',
      speechTooltipUnavailable: 'Speech synthesis is unavailable in this browser or current environment.',
    },
  },
} as const;
